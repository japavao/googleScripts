function onEdit(e){
  ...
  var notesColumn = 4; 
  var inProgressColumn = "E"; //Edit with Actual Column for In Progress by column letter
  var completedColumn = "F";  //Edit with Actual Column for Modified by column letter
  var lastModifiedColumn = "G"; //Edit with Actual Column for Modified by column letter
